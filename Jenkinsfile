        ...
        stage('Deliver') {
            steps {
                ...
                withCredentials([string(credentialsId: 'githubToken', variable: 'GITHUB_TOKEN')]) {
                    bat 'mvn release:prepare release:perform -Dbranch=editJenkins -DautoVersionSubmodules=true -DskipTests=true -Darguments="-Dmaven.deploy.skip=true -Dgithub.token=${GITHUB_TOKEN}" -DallowTimestampedSnapshots=true'
                }
